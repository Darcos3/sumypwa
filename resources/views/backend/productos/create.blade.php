                ...
                <div class="card-body p-5">
                    ...
                    @csrf
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nuevo" value="" id="nuevo">
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control" type="date" name="nuevo_vencimiento" value="" id="nuevo_vencimiento">
                        </div>
                        <div class="col-md-3">
                            <label for="sku" class="form-label">Facturar sin existencias</label>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="facturar_sinexistencias" value="" id="facturar_sinexistencias" >
