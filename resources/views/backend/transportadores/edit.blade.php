        ...
        <div class="col-md-12">
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    ...
                    <hr>
                    <div class="row g-3">
                        <form class="row g-3" id="registro" class="kt-form kt-form--label-right" method="POST" action="{{ route('transportadors.update', $transportador->id) }}" role="form" enctype='multipart/form-data'>
                        @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="email" name="email" value="{{$transportador->email}}" disabled>
                            </div>
                            <div class="col-md-6">
