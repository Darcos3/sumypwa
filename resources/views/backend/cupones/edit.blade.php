        ...
        <div class="col-md-12">
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    <form class="row g-3" id="registro" class="kt-form kt-form--label-right" method="POST" action="{{ route('cupones.update', $cupon->id) }}" role="form" enctype='multipart/form-data'>
                        @csrf
                        {{ method_field('PATCH') }}
                        <div class="col-md-12">
                            <label for="nombre" class="form-label">Estado</label>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="estado" id="flexCheckChecked" {{ $cupon->estado ? 'checked' : ''}}>
                                <label class="form-check-label" for="flexCheckChecked">Activar cupón</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="codigo" name="codigo" value="{{ $cupon->codigo }}">
                        </div>
                        <div class="col-md-6">
                            <label for="usos" class="form-label">Usos</label>
                            <input type="number" class="form-control" id="usos" name="usos" value="{{ $cupon->usos }}">
                        </div>
                        <div class="col-md-6">
                            <label for="usos" class="form-label">Vencimiento</label>
                            <input type="date" id="hoy" style="display:none">
                            <input type="date" class="form-control" id="vencimiento" name="vencimiento" value="{{ $cupon->vencimiento }}">
                        </div>
                        
                        <div class="col-md-3">
                            <label for="descuento_dinero" class="form-label">Descuento en $</label>
                            <input type="number" class="form-control" id="descuento_dinero" name="descuento_dinero" value="{{ $cupon->descuento_dinero }}">
                        </div>

                        <div class="col-md-3">
                            <label for="nombre" class="form-label">Descuento Pesos</label>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="dtopesos" id="dtopesos" {{ $cupon->dtopesos ? 'checked' : ''}}>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" step=".1" class="form-control" id="descuento_porcentaje" name="descuento_porcentaje" value="{{ $cupon->descuento_porcentaje }}">
                        </div>

                        <div class="col-md-3">
                            <label for="nombre" class="form-label">Descuento Porcentaje</label>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="dtoporcentaje" id="dtoporcentaje" {{ $cupon->dtoporcentaje ? 'checked' : ''}}>
                                <label class="form-check-label" for="flexCheckChecked">Activar</label>
                            </div>
                        </div>
                        <div class="col-12">
