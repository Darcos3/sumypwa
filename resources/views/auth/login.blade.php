            ...
            <div class="my-4 my-xl-8">
                <div class="row">
                    <div class="col-md-5 ml-xl-auto mr-md-auto mr-xl-0 mb-8 mb-md-0">
                        ...
                        <p class="text-gray-90 mb-4">Inicia sesión</p>
                        <!-- End Title -->
                        <form class="js-validate" novalidate="novalidate" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-1">
                                ...
                                <div class="mb-2">
                                    <a class="text-blue" href="{{ route('password.request') }}">¿Olvidó su contraseña?</a>
                                </div>
                            </div>
                            <!-- End Button -->
                        </form>
                    ...
                    <div class="col-md-5 ml-md-auto ml-xl-0 mr-xl-auto">
                        ...
                        <form class="js-validate" novalidate="novalidate" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="js-form-message form-group mb-5">
                                <label class="form-label" for="email">Nombre
                                    <span class="text-danger">*</span>
                                </label>
                            ...
                            <!-- Button -->
                             <div class="js-form-message mb-3">
                                <div class="custom-control custom-checkbox d-flex align-items-center">
                                    <input type="checkbox" class="custom-control-input" id="acepto" name="acepto"
                                    data-error-class="u-has-error"
                                    data-success-class="u-has-success">
                                    <label class="custom-control-label form-label" for="acepto">
                                        Para tal efecto, se entenderán conocidos y aceptados estos Términos y Condiciones por el hecho de su aceptación mediante su expresión de voluntad a través de un "click" en el recuadro respectivo.
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="mb-6">
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-primary-dark-w px-5" id="btnregistrar" disabled>Registrar</button>
                                </div>
                            </div>
                            <!-- End Button -->
                        </form>
