                    ...
                    <div class="container">
                        <div class="d-flex align-items-center">
                            <div class="topbar-left">
                                <a href="#" class="text-gray-110 font-size-13 u-header-topbar__nav-link">Precios bajos siempre</a>
                            </div>
                            <div class="topbar-right ml-auto">
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                        Servicio al cliente <a href="tel:0573001234567" class="u-header-topbar__nav-link"><i class="ec ec-phone mr-1"></i>(057) 300 123 45 67</a>
                                    </li>
                                    <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                        ...
                                        <a id="sidebarNavToggler" href="javascript:;" role="button" class="u-header-topbar__nav-link"
                                            ...
                                            <i class="ec ec-user mr-1"></i> Registrarse <span class="text-gray-50">o</span> Ingresar
                                        </a>
                                    ...
                                    <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                        <ul class="navbar-nav u-header__navbar-nav">
                                            ...
                                            <li class="nav-item u-header__nav-item">
                                                <a class="nav-link u-header__nav-link" href="#">Quienes Somos</a>
                                            </li>
                                            <li class="nav-item u-header__nav-item">
                                                <a class="nav-link u-header__nav-link" href="#">Contáctenos</a>
                                            </li>
                                            <li class="nav-item u-header__nav-item">
                                                <a class="nav-link u-header__nav-link" href="#">Nuestra Garantía</a>
                                            </li>
                                            <li class="nav-item u-header__nav-item">
                                                <a class="nav-link u-header__nav-link" href="#">Cómo Comprar</a>
                                            </li>
                                            <li class="nav-item u-header__nav-item">
                                                <a class="nav-link u-header__nav-link" href="#">Términos y Condiciones</a>
                                            </li>
                                            <li class="nav-item u-header__nav-item">
                                                <a class="nav-link u-header__nav-link" href="#">Políticas de Privacidad</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- End Navigation -->
                            ...
                            <div class="d-xl-none col col-xl-auto text-right text-xl-left pl-0 pl-xl-3 position-static">
                                <div class="d-inline-flex">
                                    <ul class="d-flex list-unstyled mb-0 align-items-center">
                                        ...
                                        <li class="col d-none d-xl-block"><a href="../shop/wishlist.html" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Favoritos"><i class="font-size-22 ec ec-favorites"></i></a></li>
                                        ...
                                        <li class="col pr-xl-0 px-2 px-sm-3">
                                            <a href="../shop/cart.html" class="text-gray-90 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Carrito">
                                        ...
                                        <div class="card border-0 rounded-0">
                                            <div class="card-header bg-primary rounded-0 card-collapse border-0" id="basicsHeadingOne">
                                                <button type="button" class="btn-link btn-remove-focus btn-block d-flex card-btn py-3 text-lh-1 px-4 shadow-none btn-primary rounded-top-lg border-0 font-weight-bold text-gray-90"
                                                    ...
                                                    <span class="pl-1 text-gray-90">Por Categoría</span>
                                                        ...
                                                        <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                                            <ul class="navbar-nav u-header__navbar-nav border-primary border-top-0">
                                                                <li class="nav-item u-header__nav-item"
                                                                    data-event="hover"
                                                                    data-position="left">
                                                                    <a href="#" class="nav-link u-header__nav-link font-weight-bold">Destacados</a>
                                                                </li>
                                                                <li class="nav-item u-header__nav-item"
                                                                    data-event="hover"
                                                                    data-position="left">
                                                                    <a href="#" class="nav-link u-header__nav-link font-weight-bold">Combos</a>
                                                                </li>
                                                                <li class="nav-item u-header__nav-item"
                                                                    data-event="hover"
                                                                    data-position="left">
                                                                    <a href="#" class="nav-link u-header__nav-link font-weight-bold">Novedades</a>
                                                                </li>
                                                                @foreach ($categoriasPrincipales as $catPrincipal)
                                                                    <li class="nav-item u-header__nav-item"
                                                                        data-event="hover"
                                                                        data-position="left">
                                                                        <a href="{{ route('categorias.show', App\Models\Categoria::generarUrl($catPrincipal) ) }}" class="nav-link u-header__nav-link font-weight-bold">{{$catPrincipal->nombre}}</a>
                                                                    </li>
                            ...
                            <div class="col align-self-center">
                                ...
                                <form class="js-focus-state">
                                    ...
                                    <div class="input-group">
                                        <input type="email" class="form-control py-2 pl-5 font-size-15 border-0 height-40 rounded-left-pill" name="email" id="searchProduct" placeholder="Buscar" aria-label="Buscar" aria-describedby="searchProduct1" required>
                                        <div class="input-group-append">
                                            <!-- Select -->
                            ...
                            <div class="col-md-auto align-self-center">
                                <div class="d-flex">
                                    <ul class="d-flex list-unstyled mb-0">
                                        ...
                                        <li class="col"><a href="#" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Favoritos"><i class="font-size-22 ec ec-favorites"></i></a></li>
                                        <li class="col pr-0">
                                            <a href="#" class="text-gray-90 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Carrito">
                                                ...
                                                <span class="font-weight-bold font-size-16 text-gray-90 ml-3">$0.00</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
        ...
        <footer>
            ...
            <div class="container d-none d-lg-block mb-3">
                <div class="row">
                    <div class="col-wd-3 col-lg-4">
                        <div class="widget-column">
                            <div class="border-bottom border-color-1 mb-5">
                                <h3 class="section-title section-title__sm mb-0 pb-2 font-size-18">Destacados</h3>
                            </div>
                            <ul class="list-unstyled products-group">
                                @forelse ($destacados as $destacado)
                                    <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                        <div class="col-auto">
                                            <a href="{{ route('productos.show', $destacado->slug) }}" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('storage/imagenes_producto/75x75/'.$destacado->imagen) }}" alt="Image Description"></a>
                                        </div>
                                        <div class="col pl-4 d-flex flex-column">
                                            <h5 class="product-item__title mb-0"><a href="{{ route('productos.show', $destacado->slug) }}" class="text-blue font-weight-bold">{{ $destacado->nombre}}</a></h5>
                                ...
                                @empty
                                    <p>En este momento no tenemos artículos destacados.</p>
                                @endforelse
                            </ul>
                        </div>
                    </div>
                    <div class="col-wd-3 col-lg-4">
                        <div class="border-bottom border-color-1 mb-5">
                            <h3 class="section-title section-title__sm mb-0 pb-2 font-size-18">Promociones</h3>
                        </div>
                        <ul class="list-unstyled products-group">
                            @forelse ($promociones as $promocion)
                                <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                    <div class="col-auto">
                                        <a href="{{ route('productos.show', $promocion->slug) }}" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('frontend/assets/img/75X75/img4.jpg') }}" alt="Image Description"></a>
                                    </div>
                                    <div class="col pl-4 d-flex flex-column">
                                        <h5 class="product-item__title mb-0"><a href="{{ route('productos.show', $promocion->slug) }}" class="text-blue font-weight-bold">{{ $promocion->nombre}}</a></h5>
                                        <div class="prodcut-price mt-auto flex-horizontal-center">
                                            <ins class="font-size-15 text-decoration-none">${{ $promocion->precio_descuento}}</ins>
                                            <del class="font-size-12 text-gray-9 ml-2">${{ $promocion->precio}}</del>
                                        </div>
                                    </div>
                                </li>
                            @empty
                                <p>En este momento no tenemos artículos en promoción.</p>
                            @endforelse
                        </ul>
                    </div>
                    <div class="col-wd-3 col-lg-4">
                        <div class="border-bottom border-color-1 mb-5">
                            <h3 class="section-title section-title__sm mb-0 pb-2 font-size-18">Novedades</h3>
                        </div>
                        <ul class="list-unstyled products-group">
                            @forelse ($novedades as $novedad)
                                <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                    <div class="col-auto">
                                        <a href="{{ route('productos.show', $novedad->slug) }}" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('frontend/assets/img/75X75/img4.jpg') }}" alt="Image Description"></a>
                                    </div>
                                    <div class="col pl-4 d-flex flex-column">
                                        <h5 class="product-item__title mb-0"><a href="{{ route('productos.show', $novedad->slug) }}" class="text-blue font-weight-bold">{{ $promocion->nombre}}</a></h5>
                                        <div class="prodcut-price mt-auto flex-horizontal-center">
                                            <ins class="font-size-15 text-decoration-none">{{ $promocion->precio}}</ins>
                                        </div>
                                    </div>
                                </li>
                            @empty
                                <p>En este momento no tenemos novedades en artículos.</p>
                            @endforelse
                        </ul>
                    </div>
                    ...
                    <div class="col-wd-3 col-lg-4">
                        <div class="border-bottom border-color-1 mb-5">
                            <h3 class="section-title section-title__sm mb-0 pb-2 font-size-18">Mejores Valorados</h3>
                        </div>
                        <p>En este momento no tenemos productos mejores valorados.</p>
                        {{-- <ul class="list-unstyled products-group">
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="#" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('frontend/assets/img/75X75/img7.jpg') }}" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                                    <h5 class="product-item__title mb-0"><a href="#" class="text-blue font-weight-bold">Mejor valorado 1</a></h5>
                                    ...
                                    <div class="prodcut-price mt-auto">
                                        <div class="font-size-15">$72500.00</div>
                                    </div>
                                </div>
                            </li>
                        </ul> --}}
                    ...
                    {{-- <div class="col-wd-3 d-none d-wd-block">
                        <a href="../shop/shop.html" class="d-block"><img class="img-fluid" src="{{ asset('frontend/assets/img/330X360/img1.jpg') }}" alt="Image Description"></a>
                    </div> --}}
                </div>
            </div>
                        ...
                        <div class="col-lg-7 mb-md-3 mb-lg-0">
                            <div class="row align-items-center">
                                <div class="col-auto flex-horizontal-center">
                                    ...
                                    <h2 class="font-size-20 mb-0 ml-3">Inscríbete a nuestro boletín</h2>
                                </div>
                                <div class="col my-4 my-md-0">
                                    <h5 class="font-size-15 ml-4 mb-0">...Y recibe <strong>$10000 en cupón en la primera compra.</strong></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            ...
                            <form class="js-validate js-form-message">
                                ...
                                <div class="input-group input-group-pill">
                                    <input type="email" class="form-control border-0 height-40" name="email" id="subscribeSrEmail" placeholder="Email" aria-label="Email" aria-describedby="subscribeButton" required
                                    data-msg="Por favor ingrese un email válido.">
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-dark btn-sm-wide height-40 py-2" id="subscribeButton">Inscribirse</button>
                                    </div>
                                </div>
                            </form>
                            <!-- End Subscribe Form -->
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="mb-4">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col pl-3">
                                        <div class="font-size-13 font-weight-light">¡Contáctenos!</div>
                                        <a href="tel:+0573001234567" class="font-size-20 text-gray-90">(057) 300 123 45 67</a>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-4">
                                ...
                                <address class="">
                                    Calle 1 # 2 - 3 Cali, Valle del Cauca, Colombia
                                </address>
                            </div>
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                <div class="col-12 col-md mb-4 mb-md-0">
                                    <h6 class="mb-3 font-weight-bold">Encuéntralos</h6>
                                    <!-- List Group -->
...
{{--
                                ...
                                <div class="col-12 col-md mb-4 mb-md-0">
                                    ...
                                    <ul class="list-group list-group-flush list-group-borderless mb-0 list-group-transparent">
                                        ...
                                        <li><a class="list-group-item list-group-item-action" href="#">Ordenes</a></li>
                                        <li><a class="list-group-item list-group-item-action" href="#">Favoritos</a></li>
                                        <li><a class="list-group-item list-group-item-action" href="#">Devoluciones</a></li>
                                        <li><a class="list-group-item list-group-item-action" href="#">Cómo Comprar</a></li>
            ...
            <div class="bg-gray-14 py-2">
                <div class="container">
                    <div class="flex-center-between d-block d-md-flex">
                        <div class="mb-3 mb-md-0">Desarrollado por <a href="#" class="font-weight-bold text-gray-90">AltoSentido.net</a></div>
                            ...
                            <div class="u-sidebar__content u-header-sidebar__content">
                                <form class="js-validate">
                                    ...
                                    <div id="signup" style="display: none; opacity: 0;" data-target-group="idForm">
                                        <!-- Title -->
                                        <header class="text-center mb-7">
                                        <h2 class="h4 mb-0">Bienvenid@ a Ferretería</h2>
                                        <p>Lele los campos para iniciar.</p>
                                        </header>
                                        <!-- End Title -->
                                        ...
                                        <div class="mb-2">
                                            <button type="submit" class="btn btn-block btn-sm btn-primary transition-3d-hover">Empezar</button>
                                        </div>
                                    ...
                                    <div id="forgotPassword" style="display: none; opacity: 0;" data-target-group="idForm">
                                        <!-- Title -->
                                        <header class="text-center mb-7">
                                            <h2 class="h4 mb-0">Recupere la contraseña.</h2>
                                            <p>Ingrese su email y un correo con las instrucciones será enviado.</p>
                                        </header>
                                        <!-- End Title -->
                                        ...
                                        <div class="text-center mb-4">
                                            ...
                                            <a class="js-animation-link small" href="javascript:;"
                                               data-target="#login"
                                               data-link-group="idForm"
                                               data-animation-in="slideInUp">Ingresa
                                            </a>
                                        </div>
                                    </div>
                                    <!-- End Forgot Password -->
