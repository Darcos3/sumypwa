            ...
            <div class="mb-xl-14 mb-6">
                <div class="row">
                    <div class="col-md-5 mb-4 mb-md-0">
                        ...
                        @endforeach
                        {{-- <div class="js-slide">
                            <img class="img-fluid" src="assets/images/producto/taladro.jpg" alt="Image Description">
                        </div>
                        <div class="js-slide">
                            <img class="img-fluid" src="assets/images/producto/taladro2.jpg" alt="Image Description">
                        </div>
                        <div class="js-slide">
                            <img class="img-fluid" src="assets/images/producto/taladro3.jpg" alt="Image Description">
                        </div>
                        <div class="js-slide">
                            <img class="img-fluid" src="assets/images/producto/taladro4.jpg" alt="Image Description">
                        </div> --}}
                    </div>
            ...
            <div class="col-md-7 mb-md-6 mb-lg-0">
                <div class="mb-2">
                    <div class="border-bottom mb-3 pb-md-1 pb-3">
                        ...
                        <div class="d-md-flex align-items-center">
                            ...
                            <div class="ml-md-3 text-gray-9 font-size-14">Disponibilidad: <span class="{{ $producto->cantidad < 10 ? 'text-red' : 'text-green' }} font-weight-bold">{{ $producto->cantidad }} en stock</span></div>
                        </div>
                    </div>
                    <div class="flex-horizontal-center flex-wrap mb-4">
                        ...
                        @endauth
                        @guest
                            <a href="{{ route('login') }}" data-combo="0" data-id="{{$producto->id}}" class="text-gray-6 font-size-13"><i class="fas fa-heart"></i> Favoritos</a>
                        @endguest
                    ...
                    {{-- <div class="mb-2">
                        <ul class="font-size-14 pl-3 ml-1 text-gray-110">
                            <li>Doble aislamiento</li>
                            <li>Potente motor de 500W </li>
                            <li>100% Rodamientos de bolas y rodillos </li>
                            <li>Mango ergonómico </li>
                        </ul>
                    </div> --}}
                    {{-- <p>Taladro de impacto Mandril de 1/2”.</p> --}}
                        ...
                        <div class="d-flex align-items-baseline">
                            @if( auth()->user()->rol_user == null )
                                ...
                                @if ($producto->precio_descuento)
                                    <ins class="font-size-36 text-decoration-none">${{ number_format($producto->precio_descuento, 0, ',', '.')}}</ins>
                                    <del class="font-size-20 ml-2 text-gray-6">${{ number_format($producto->precio,0,'.','.')}}</del>
                                @else
                                    <ins class="font-size-36 text-decoration-none">${{ number_format($producto->precio,0,'.','.')}}</ins>
                                @endif
                            @endif

                            @if( auth()->user()->rol_user == 3 )
                                <ins class="font-size-36 text-decoration-none">${{ number_format($producto->precio_ferretero,0,'.','.')}}</ins>
                            @endif
                    ...
                    {{-- <div class="border-top border-bottom py-3 mb-4">
                        <div class="d-flex align-items-center">
                            ...
                            <option value="one" selected>Amarillo con negro</option>
                            <option value="two">Rojo con negro</option>
                        </select>
                        <!-- End Select -->
                    </div> --}}
                </div>
                <div class="d-md-flex align-items-end mb-3">
                    <div class="max-width-150 mb-4 mb-md-0">
                        ...
                        <div class="border rounded-pill py-2 px-3 border-color-1">
                            <div class="js-quantity row align-items-center">
                                <div class="col">
                                    <input id="cantidad" class="js-result form-control h-auto border-0 rounded p-0 shadow-none" type="number" value="1" max="{{$producto->cantidad}}">
                                </div>
                    ...
                    <div class="ml-md-3">
                        ...
                        @endauth
                        @guest
                            <a href="{{ route('login') }}" class="btn px-5 btn-primary-dark transition-3d-hover"><i class="ec ec-add-to-cart mr-2 font-size-20"></i> Añadir al carrito</a>
                        @endguest
                    </div>
                </div>
                <div  class="mt-3">
                    <ul class="nav flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                        ...
                        <li class="nav-item text-gray-111 flex-shrink-0 flex-xl-shrink-1"><strong>Categoría:</strong> <a href="{{ route('categorias.show', App\Models\Categoria::generarUrl($producto->categoria) ) }}" class="text-blue">{{ $producto->categoria->nombre }}</a></li>
                        <li class="nav-item text-gray-111 mx-3 flex-shrink-0 flex-xl-shrink-1">/</li>
                                ...
                                {{-- <tr>
                                    ...
                                    >
                                        @foreach ($atributosSel as $term)
                                            <tr>
                                                <th class="px-4 px-xl-5">{{ $term->atributo->nombre }}</th>
                                                <td>
                                                    @foreach ($producto->terminos->where('atributo_id', $term->atributo->id) as $termino)
                                                        @if ($loop->last)
                                                            <div class="js-slide text-center d-inline-block" style="" title="{{ $termino->nombre }}">
                                                                <a href="{{ route('atributos.show', $termino->nombre) }}">
                                                                    <img class="img-fluid m-auto max-width-50 max-height-50" src="{{ asset('storage/terminos/'.$termino->imagen )  }}" alt="Image Description">
                                                                    <br><small>{{ $termino->nombre }}</small>
                                                                </a>
                                                            </div>
                                                        @else
                                                            <div class="js-slide text-center d-inline-block" style="" title="{{ $termino->nombre }}">
...
@section('scripts')
    <script type="text/javascript">
        ...
        $( "#boton-anadir" ).click(function(e) {
            ...
            $.ajax({
                type:"GET",
                url:"/anadircarrito?id="+{{$producto->id}}+"&cantidad="+cantidad,
                success: function(data) {
