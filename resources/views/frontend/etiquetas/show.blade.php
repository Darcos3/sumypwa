...
@section('titulo', 'Productos por etiqueta')
    ...
    <main id="content" role="main">
                ...
                <div class="my-md-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                            ...
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1" aria-current="page">Etiquetas</li>
                            {{-- @foreach ($etiqueta as $et ) --}}
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">{{ $etiqueta->nombre }}</li>
                            {{-- @endforeach --}}
                        </ol>
                    </nav>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9 col-wd-9gdot5 text-center">
                    <!-- Shop-control-bar Title -->
                    {{-- <div class="flex-center-between mb-3"> --}}
                        <div class="row text-center mb-5">
                            {{-- <h3 class="font-size-25">Productos {{ $etiqueta->nombre }}</h3> --}}
                            <img src="{{ asset('storage/etiquetas/original/'.$etiqueta->imagen )  }}" class="img-fluid rounded" style="width: 100%; height: 350px;"><br>
                        </div>
                    {{-- </div> --}}
