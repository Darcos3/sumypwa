            ...
            <div class="row">
                                        ...
                                        @if (in_array($term->id, $terminos))
                                            <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="radio" class="custom-control-input" id="termino_{{ $term->id }}" name="termino[]" value={{ $term->id }} checked="false" >
                ...
                <div class="col-xl-9 col-wd-9gdot5">
                    ...
                    <div class="bg-gray-1 flex-center-between borders-radius-9 py-1">
                        ...
                        <div class="d-flex">
                            <form  id="form_orden" action="/categorias/{{ $categoria->slug }}">
                                <!-- Select -->
                            ...
                            <form class="ml-2 d-none d-xl-block" id="form_selectorresultados" action="/categorias/{{ $categoria->slug }}">
                                <!-- Select -->
